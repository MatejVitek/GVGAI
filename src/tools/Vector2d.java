...
/**
 * This class represents a vector, or a position, in the map. PTSP-Competition Created by Diego Perez, University of Essex. Date: 19/12/11
 */
public class Vector2d {
	 ...
	 * 
	 * @param v
	 *            Vector to add, to be scaled by w
	 * @param w
	 *            Scale of v.
	 ...
	 * 
	 * @param fac
	 *            factor to multiply this vector by.
	 ...
	 * 
	 * @param v
	 *            vector to do the scalar product with.
