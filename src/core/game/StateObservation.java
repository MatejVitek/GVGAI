...
public class StateObservation {
	...
	/**
	 * This is the model of the game, used to apply an action and get to the next state. This model MUST NOT be public.
	 */
	...
	/**
	 * Advances the state using the action passed as the move of the agent. It updates all entities in the game. It modifies the object 'this' to represent the next state after the action has been
	 * executed and all entities have moved.
	 * <p/>
	...
	/**
	 * This method retrieves a list of events that happened so far in the game. In this context, events are collisions of the avatar with other sprites in the game. Additionally, the list also
	 * contains information about collisions of a sprite created by the avatar (usually by using the action Types.ACTIONS.ACTION_USE) with other sprites. The list is ordered asc. by game step.
	 *
	 ...
	 * type Observation. Each Observation holds the position, unique id and sprite id of that particular sprite.
	 *
	 ...
	 * contains a list of objects of type Observation. Each Observation holds the position, unique id and sprite id of that particular sprite.
	 *
	...
	/**
	 * Returns a list of observations of sprites that move, but are NOT NPCs in the game. As there can be movable sprites of different type, each entry in the array corresponds to a sprite type. Every
	 * ArrayList contains a list of objects of type Observation. Each Observation holds the position, unique id and sprite id of that particular sprite.
	 *
	...
	/**
	 * Returns a list of observations of movable (not NPCs) sprites in the game. As there can be movable (not NPCs) sprites of different type, each entry in the array corresponds to a sprite type.
	 ...
	 * objects of type Observation. Each Observation holds the position, unique id and sprite id of that particular sprite.
	 *
	...
	/**
	 * Returns a list of observations of sprites created by the avatar (usually, by applying the action Types.ACTIONS.ACTION_USE). As there can be sprites of different type, each entry in the array
	 * corresponds to a sprite type. Every ArrayList contains a list of objects of type Observation. Each Observation holds the position, unique id and sprite id of that particular sprite.
	 *
