...
public class StateObservationMulti extends StateObservation {
	...
	/**
	 * Method overloaded for multi player games. Now passes an array of actions for all players in the game, the index in the array corresponding to playerID. Advances the state using the action
	 * passed as the move of the agents. It updates all entities in the game. It modifies the object 'this' to represent the next state after the actions have been executed and all entities have
	 * moved.
	 * <p/>
	 * Note: stochastic events will not be necessarily the same as in the real game.
	 *
	 * @param actions
	 *            array of agent actions to execute in the next cycle for all players.
	 */
