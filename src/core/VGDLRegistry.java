...
public class VGDLRegistry {
	...
	/**
	 * Maps strings to int. Strings are VGDL identifiers for SPRITE TYPES, while integers are their unique int identifier counterparts.
	 */
	...
	public int getRegisteredSpriteValue(String key) {
		if (sprite_mapping.containsKey(key)) return sprite_mapping.get(key);
		return -1;
	}
