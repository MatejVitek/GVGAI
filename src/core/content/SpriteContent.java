...
public class SpriteContent extends Content {
	...
	/**
	 * Class of the element defined by this content. It is only assigned when processing the tree of contents.
	 */
	public String referenceClass;

	/**
	 * Indicates the int - types of the sprite (hierarchical identifiers). From the type till the top of the hierarchy.
	 */
	...
	public void assignTypes(ArrayList<String> types) {
		if (itypes == null) itypes = new ArrayList<Integer>();
