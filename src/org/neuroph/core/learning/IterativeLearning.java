...
abstract public class IterativeLearning extends LearningRule implements Serializable {
	...
	/**
	 * Max training iterations (when to stopLearning training) TODO: this field should be private, to force use of setMaxIterations from derived classes, so iterationsLimited flag is also set at the
	 * sam etime.Wil that break backward compatibility with serialized networks?
	 */
