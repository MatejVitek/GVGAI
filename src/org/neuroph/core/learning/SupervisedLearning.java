...
abstract public class SupervisedLearning extends IterativeLearning implements Serializable {
	...
	/**
	 * Stopping condition: training stops if total network error change is smaller than minErrorChange for minErrorChangeIterationsLimit number of iterations
	 */
	private double minErrorChange = Double.POSITIVE_INFINITY;
	/**
	 * Stopping condition: training stops if total network error change is smaller than minErrorChange for minErrorChangeStopIterations number of iterations
	 */
