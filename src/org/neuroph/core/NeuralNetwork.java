...
public class NeuralNetwork<L extends LearningRule> implements Serializable {
	...
	/**
	 * List of network input neurons. These neurons are used to set external input to network.
	 */
	private List<Neuron> inputNeurons;

	/**
	 * List of network output neurons. These neurons are used to read network's output.
	 */
