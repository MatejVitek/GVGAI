...
/**
 * This class represents single data row in a data set. It has input and desired output for supervised learning rules. It can also be used only with input for unsupervised learning rules.
 *
