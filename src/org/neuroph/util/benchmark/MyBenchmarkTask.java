...
public class MyBenchmarkTask extends BenchmarkTask {
	...
	/**
	 * Benchmrk preparation consists of training set and neural networ creatiion. This method generates training set with 100 rows, where every row has 10 input and 5 output elements Neural network
	 * has two hiddden layers with 8 and 7 neurons, and runs learning rule for 2000 iterations
	 */
	@Override
