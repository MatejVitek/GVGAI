...
public class LMS extends SupervisedLearning implements Serializable {
	...
	/**
	 * Creates a new LMS learning rule This learning rule is used to train Adaline neural network, and this class is base for all LMS based learning rules like PerceptronLearning, DeltaRule,
	 * SigmoidDeltaRule, Backpropagation etc.
	 */
	public LMS() {
