...
/**
 * Delta rule learning algorithm for perceptrons with sigmoid (or any other diferentiable continuous) functions. TODO: Rename to DeltaRuleContinuous (ContinuousDeltaRule) or something like that, but
 * that will break backward compatibility, posibly with backpropagation which is the most used
 *
 * @see LMS
