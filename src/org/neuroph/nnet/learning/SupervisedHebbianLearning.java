...
public class SupervisedHebbianLearning extends LMS {
	...
	/**
	 * Learn method override without network error and iteration limit Implements just one pass through the training set Used for testing - debugging algorithm public void learn(TrainingSet
	 * trainingSet) { Iterator iterator=trainingSet.iterator(); while(iterator.hasNext()) { SupervisedTrainingElement trainingElement = (SupervisedTrainingElement)iterator.next();
