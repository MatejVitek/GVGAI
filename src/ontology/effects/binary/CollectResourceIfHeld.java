...
/**
 * Created with IntelliJ IDEA. User: Diego Date: 04/11/13 Time: 13:25 This is a Java port from Tom Schaul's VGDL - https://github.com/schaul/py-vgdl
 */
public class CollectResourceIfHeld extends Effect {
	...
	public void execute(VGDLSprite sprite1, VGDLSprite sprite2, Game game) {
		...
		if (sprite1.is_resource) {
			...
			if (numResourcesHeld < value) return;
