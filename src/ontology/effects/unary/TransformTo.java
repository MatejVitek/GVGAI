...
public class TransformTo extends Effect {
	...
	protected void transformTo(VGDLSprite newSprite, VGDLSprite sprite1, VGDLSprite sprite2, Game game) {
		if (newSprite != null) {
			...
			newSprite.lastrect = new Rectangle(sprite1.lastrect.x, sprite1.lastrect.y, sprite1.lastrect.width, sprite1.lastrect.height);
			...
			if (killSecond && sprite2 != null) game.killSprite(sprite2, true);
		}
	}
