...
/**
 * Created with IntelliJ IDEA. User: Diego Date: 04/11/13 Time: 15:57 This is a Java port from Tom Schaul's VGDL - https://github.com/schaul/py-vgdl
 */
public class AddHealthPointsToMax extends Effect {
	...
	public void execute(VGDLSprite sprite1, VGDLSprite sprite2, Game game) {
		...
		if (sprite1.healthPoints > sprite1.maxHealthPoints) sprite1.maxHealthPoints = sprite1.healthPoints;
