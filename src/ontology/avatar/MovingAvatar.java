...
/**
 * Created with IntelliJ IDEA. User: Diego Date: 22/10/13 Time: 18:04 This is a Java port from Tom Schaul's VGDL - https://github.com/schaul/py-vgdl
 */
public class MovingAvatar extends VGDLSprite {
	...
	/**
	 * Disqualified flag, moved from Game class to individual players, as there may be more than 1 in a game; variable still in Game class for single player games to keep back-compatibility
	 */
	...
	protected void requestPlayerInput(Game game) {
		...
		if (!actions.contains(action)) action = Types.ACTIONS.ACTION_NIL;
