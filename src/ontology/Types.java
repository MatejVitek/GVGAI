...
public class Types {
	...
	public static int[][] ALL_ACTIONS = new int[][]{{KeyEvent.VK_UP, KeyEvent.VK_LEFT, KeyEvent.VK_DOWN, KeyEvent.VK_RIGHT, KeyEvent.VK_SPACE, KeyEvent.VK_ESCAPE},
			{KeyEvent.VK_W, KeyEvent.VK_A, KeyEvent.VK_S, KeyEvent.VK_D, KeyEvent.VK_SHIFT, KeyEvent.VK_ESCAPE}};

	public static enum ACTIONS {
		ACTION_NIL(new int[]{0, 0}), ACTION_UP(new int[]{KeyEvent.VK_UP, KeyEvent.VK_W}), ACTION_LEFT(new int[]{KeyEvent.VK_LEFT, KeyEvent.VK_A}), ACTION_DOWN(
				new int[]{KeyEvent.VK_DOWN, KeyEvent.VK_S}), ACTION_RIGHT(
						new int[]{KeyEvent.VK_RIGHT, KeyEvent.VK_D}), ACTION_USE(new int[]{KeyEvent.VK_SPACE, KeyEvent.VK_SHIFT}), ACTION_ESCAPE(new int[]{KeyEvent.VK_ESCAPE, KeyEvent.VK_ESCAPE});
